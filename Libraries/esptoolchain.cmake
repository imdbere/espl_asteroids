...
find_program(ARM_GCC arm-none-eabi-gcc ~/Dokumente/gcc-arm/gcc/bin NO_DEFAULT_PATH)
...
find_program(ARM_GCXX arm-none-eabi-g++ ~/Dokumente/gcc-arm/gcc/bin NO_DEFAULT_PATH)
...
find_program(ARM_LINKER arm-none-eabi-ld ~/Dokumente/gcc-arm/gcc/bin NO_DEFAULT_PATH)
...
find_program(ARM_OBJCOPY arm-none-eabi-objcopy ~/Dokumente/gcc-arm/gcc/bin NO_DEFAULT_PATH)
...
find_program(ARM_OBJDUMP arm-none-eabi-objdump ~/Dokumente/gcc-arm/gcc/bin NO_DEFAULT_PATH)
...
find_program(ARM_AR arm-none-eabi-ar ~/Dokumente/gcc-arm/gcc/bin NO_DEFAULT_PATH)
...
find_program(ARM_RANLIB arm-none-eabi-ranlib ~/Dokumente/gcc-arm/gcc/bin NO_DEFAULT_PATH)
...
find_program(ARM_SIZE arm-none-eabi-size ~/Dokumente/gcc-arm/gcc/bin NO_DEFAULT_PATH)
...
find_program(ST_FLASH st-flash ~/Dokumente/gcc-arm/stlink NO_DEFAULT_PATH)
...
set(CMAKE_C_FLAGS "-mcpu=cortex-m4 -march=armv7e-m -mtune=cortex-m4 -mlittle-endian -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -std=c99 -Wall -Wunused-value -O3 -ffast-math -ffunction-sections -fdata-sections -Wl,--gc-sections -fno-common --param max-inline-insns-single=1000 -Wno-incompatible-pointer-types -DUSE_STDPERIPH_DRIVER -DGFX_USE_OS_FREERTOS=TRUE -DSTM32F429_439xx=TRUE -g")
